                        ...
                        <div class="hero-content" data-aos="zoom-in" data-aos-delay="200">
                            <div class="content-header">
                                ...
                                <p>Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea
                                    commodo consequat. Connect with verified real estate professionals.</p>
                            </div>
                        ...
                        <div class="hero-visual" data-aos="fade-left" data-aos-delay="400">
                            <div class="visual-container">
                                <div class="featured-property">
                                    <img src={{ asset('assets/img/real-estate/property-exterior-8.webp') }}
                                ...
                                <div class="overlay-images">
                                    <div class="overlay-img overlay-1">
                                        <img src={{ asset('assets/img/real-estate/property-interior-4.webp') }}
                                            alt="Interior View" class="img-fluid">
                                    </div>
                                    <div class="overlay-img overlay-2">
                                        <img src={{ asset('assets/img/real-estate/property-exterior-2.webp') }}
                                            alt="Exterior View" class="img-fluid">
                                    </div>
                                </div>

                                <div class="agent-card">
                                    <div class="agent-profile">
                                        <img src={{ asset('assets/img/real-estate/agent-7.webp') }} alt="Agent Profile"
                                            class="agent-photo">
                ...
                <div class="col-lg-5" data-aos="zoom-in" data-aos-delay="200">
                    <div class="image-gallery">
                        ...
                        <div class="secondary-image">
                            <img src={{ asset('assets/img/real-estate/property-interior-4.webp') }} alt="Luxury Interior"
                                class="img-fluid">
                        </div>
                    </div>
                </div>
